    ...
    return (
        <div className="space-y-6 animate-in slide-in-from-right-4 duration-500 pb-24 lg:pb-0">
            <header className="flex items-center gap-4">
                ...
                <div>
                    <h2 className="text-2xl font-black text-zinc-950 dark:text-white uppercase leading-none">Relatórios Gerais</h2>
                    <p className="text-zinc-500 dark:text-zinc-400 font-bold text-xs uppercase mt-1">Gere listas personalizadas de alunos</p>
                </div>
            </header>
            ...
            <div className="bg-white dark:bg-zinc-900 p-6 rounded-3xl border border-zinc-100 dark:border-zinc-800 shadow-xl space-y-6">
                ...
                <div className="border-t border-zinc-100 dark:border-zinc-800 pt-6">
                    <div className="flex items-center justify-between mb-4">
                        <h3 className="font-black uppercase text-zinc-950 dark:text-white text-lg">Resultados Encontrados</h3>
                    ...
                    {loading ? (
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                            {filteredStudents.map(student => (
                                <div key={student.id} className={`flex items-center gap-3 p-3 rounded-xl border ${student.active ? 'bg-zinc-50 dark:bg-zinc-950 border-zinc-100 dark:border-zinc-800' : 'bg-red-50 dark:bg-red-900/10 border-red-100 dark:border-red-900/30 opacity-75'}`}>
                                    <div className="w-10 h-10 rounded-full bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 overflow-hidden flex-shrink-0 relative">
                                        {student.avatar ? (
                                    ...
                                    <div>
                                        <p className="font-bold text-zinc-950 dark:text-white text-sm truncate flex items-center gap-2">
                                            {student.name}
                                        </p>
